...
describe('Tests for utils', () => {
  ...
  test('tests for mix address', () => {
    ...
    expect("MIX4fwusRK88p5GexHWddUQuYJbKMJTAuBvhudgahRXKndvaM8FdPHS2Hgeo7DQxNVoSkKSEDyZeD8TYBhiwiea9PvCzay1A9Vx1C2nugc4iAmhwLGGv4h3GnABeCXHTwWEto9wEe1MWB49jLzy3nuoM81tqE2XnLvUWv").toBe(address)
    ma = MixAddressFromString("MIX4fwusRK88p5GexHWddUQuYJbKMJTAuBvhudgahRXKndvaM8FdPHS2Hgeo7DQxNVoSkKSEDyZeD8TYBhiwiea9PvCzay1A9Vx1C2nugc4iAmhwLGGv4h3GnABeCXHTwWEto9wEe1MWB49jLzy3nuoM81tqE2XnLvUWv")
    expect(ma).not.toBe(undefined);
    expect(ma!.members.join(",")).toBe(members.join(","));
    ...
    expect("").toBe(address)
    ma = MixAddressFromString("")
    expect(ma).not.toBe(undefined);
    expect(ma!.members.join(",")).toBe(members.join(","));
