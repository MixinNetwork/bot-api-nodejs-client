...
import type { DepositRequest, ProxyRequest } from './types/external';
import type { CheckAddressRequest, CheckAddressResponse, ExchangeRateResponse, ExternalTransactionResponse } from './types/network';
