...
export const reloadTheme = () => {
  ...
  case 'iOS':
    if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.reloadTheme)
      window.webkit.messageHandlers.reloadTheme.postMessage('');
    break;
  case 'Android':
  case 'Desktop':
    if (window.MixinContext && (typeof window.MixinContext.reloadTheme === 'function'))
...
export const playlist = (audios: string[]) => {
  switch (getMixinContext().platform) {
  case 'iOS':
    if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.playlist)
      window.webkit.messageHandlers.playlist.postMessage(audios);
    break;
  case 'Android':
  case 'Desktop':
    if (window.MixinContext && (typeof window.MixinContext.playlist === 'function'))
...
export const close = () => {
  ...
  case 'Android':
  case 'Desktop':
    if (window.MixinContext && (typeof window.MixinContext.close === 'function')) 
